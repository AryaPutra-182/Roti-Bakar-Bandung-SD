...
export default function Kontak() {
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      {/* Hero Banner */}
      <section className="relative bg-brand-brown py-20 overflow-hidden">
        {/* Decorative logos */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-brand-orange font-semibold text-sm uppercase tracking-widest mb-3">Hubungi Kami</p>
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-4 font-logo">Kontak</h1>
      ...
      <section className="py-10 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 -mt-12">
            ...
            {/* WA Card */}
            <a
              href="https://wa.me/6281234567890?text=Halo%2C+saya+ingin+memesan+Roti+Bakar+Bandung+SD"
              target="_blank"
              rel="noreferrer"
            ...
            >
              ...
              <span className="text-xs text-green-500 font-semibold group-hover:underline">Chat Sekarang →</span>
            </a>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 flex flex-col items-center text-center gap-3 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 group">
              <div className="w-14 h-14 rounded-2xl bg-orange-50 flex items-center justify-center text-brand-orange text-2xl group-hover:bg-brand-orange group-hover:text-white transition-all duration-300">
                <FaEnvelope />
              </div>
              <p className="font-bold text-brand-brown">Email</p>
              <p className="text-gray-500 text-sm">hello@rotibakar.com</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 flex flex-col items-center text-center gap-3 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 group">
              ...
              <p className="text-gray-500 text-sm">Senin – Minggu</p>
              <p className="text-brand-orange font-bold text-sm">16:00 – 23:00</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 flex flex-col items-center text-center gap-3 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 group">
              ...
              <p className="font-bold text-brand-brown">Alamat</p>
              <p className="text-gray-500 text-sm leading-relaxed">Jl. Batanghari No.9, Kec. Klojen, Kota Malang</p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
            ...
            <div className="lg:col-span-2 bg-brand-brown rounded-3xl p-10 flex flex-col justify-between relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-3 mb-10">
                  {["Respon cepat", "Bisa pesan & ambil sendiri", "Buka setiap hari"].map((item) => (
            ...
            <div className="lg:col-span-3">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-brand-brown">Lokasi Kami</h2>
                <a
